...
const SUPABASE_URL = process.env.NEXT_PUBLIC_API_URL
  ? process.env.NEXT_PUBLIC_API_URL.replace("/functions/v1/paisaads-api", "")
  : "https://vhlafnxhkalzwzlcbidq.supabase.co";
...
export async function GET(req: Request) {
  ...
  try {
    const imageUrl = `${SUPABASE_URL}/storage/v1/object/public/uploads/${imageName}`;
