...
@Component({
  selector: 'app-my-ads-poster',
  standalone: true,
  imports: [RouterLink],
  template: `
    <div class="space-y-6">
      <div class="flex items-center justify-between">
        <h1 class="text-2xl font-bold">My Poster Ads</h1>
        <a routerLink="/dashboard/post-ad/poster-ad" class="inline-flex items-center gap-2 px-4 py-2 bg-[#1a1a2e] text-white rounded-md text-sm">
      ...
      @if (isLoading()) {
                ...
                <tr class="border-b hover:bg-gray-50">
                  ...
                  <td class="px-4 py-3 text-sm">
                    <div class="flex gap-2">
                      <a [routerLink]="['/dashboard/edit-ad/poster-ad', ad.id]" class="text-blue-600 hover:underline">Edit</a>
                      <a [routerLink]="['/dashboard/view-ad/poster-ad', ad.id]" class="text-gray-600 hover:underline">View</a>
                    </div>
                  </td>
                </tr>
              }
        ...
        <div class="text-center py-12"><p class="text-gray-500">No poster ads found. Create your first ad!</p></div>
      }
    </div>
  `,
})
export class MyAdsPosterComponent implements OnInit {
